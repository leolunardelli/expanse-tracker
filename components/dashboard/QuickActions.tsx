...
const actions = [
  { label: 'Analytics', href: '/analytics', icon: PieChart, color: '#7F3DFF', bg: '#EEE5FF', darkBg: '#2D1F4A' },
  ...
  { label: 'YoY', href: '/analytics', icon: BarChart3, color: '#7F3DFF', bg: '#EEE5FF', darkBg: '#2D1F4A' },
];
